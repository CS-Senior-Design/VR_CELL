...
public class WhiteboardDescription : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _description.Add("Nuclear Membrane", "The function of the nuclear membrane is to act as a barrier that separates the contents of the nucleus from the cytoplasm.");
